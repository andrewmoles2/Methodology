...
# Week 1: Exercise 1 part B script
#
#####################################################################################################

#Make sure you are in the working directory that contains computer exercise 1 files (see instructions for part A)
#For example, Jon's version would be:
#setwd("C:/Users/JACKSOJP/Dropbox (Personal)/Teaching/MY465/exercises/exercise_week1")
			   
# 1. Reading in the data

MediaTimeUse <- read.csv("MY465/MediaTimeUse2.csv")

# The next command opens the dataset in one of the RStudio windows, so that you can see what it looks like.
# You can switch back to the script file by clicking on the Week 1 class.R tab
View(MediaTimeUse)  
